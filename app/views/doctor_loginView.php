...
<body>
            ...
            <div class="doctor-login-form-wrapper">
                ...
                <form class="doctor-login-form" id="doctorLoginForm" action="#" method="POST">
                    ...
                    <div class="doctor-forgot-password-wrap">
                        <a href="javascript:void(0)" class="doctor-forgot-password-link"
                            id="doctorForgotPassLink">Forgot password?</a>
                    </div>
                </form>

                <footer class="doctor-login-footer">
                    <span>Not registered? </span><a href="doctor_signupController.php" class="doctor-signup-link">Sign
                        up here</a>
                </footer>
            </div>
        </main>
    ...
    <!-- =========================================================
         ...
         ========================================================= -->
    <div class="doctorforgotpass-overlay" id="doctorForgotPassModal" aria-hidden="true" role="dialog" aria-modal="true"
        aria-labelledby="doctorForgotPassTitle">
        <div class="doctorforgotpass-card">
            <button type="button" class="doctorforgotpass-back-btn" id="doctorForgotPassBackBtn"
            ...
            <p class="doctorforgotpass-subtitle">Enter the Doctor ID or email tied to your account and we'll send a
                reset link.</p>
